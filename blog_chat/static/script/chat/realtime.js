$(function() {
    ...
    chatsock.onmessage = function(message) {
        ...
        if(data.type == "presence"){
            ...
            if(lurkers == 1){
                lurk_null = document.getElementById("lurkers-online");
                lurk_null.innerText = gettext('onlooker is online');
            }
            ...
            if(user_list.length == 1){
                user_null = document.getElementById("users-online");
                user_null.innerText = gettext('user is online');
            }
