...
from blog.utils import paginate, count_words
...
class UtilsTestCase(TestCase):
    ...
    def test_paginate(self):
        ...
        result = paginate([1, 2, 3, 4], 3, request, context, var_name='objects_list')
        self.assertEqual(len(result['objects_list']), 1)
        self.assertEqual(result['objects_list'][0], 4) 

        # check the valid page: third page
        request.GET['page'] = '3'
        result = paginate([1, 2, 3, 4, 5, 6], 2, request, context, var_name='the_list')
